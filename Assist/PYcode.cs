...
namespace SNDMS.Assist
{
   public  class PYcode
   {
       #region ESS拼音转换 首字母：EssGetChineseSpellFirst（准确）; 全拼：EssGetChineseSpellAll（不准确）
       ...
       public static string EssGetChineseSpellFirst(string strText)
       {
       ...
       public static string EssGetChineseSpellAll(string str)
       {
           if (str == null)
               return null;
        ...
        new string[][]
   {
    ...
    new string[]{"Gou","够沟狗钩勾购构苟垢句岣彀枸鞲觏缑笱诟遘媾篝佝傋冓區呴坸夠姤抅拘搆撀構泃溝煹玽簼緱耇耈耉茩蚼袧褠覯訽詬豰豿購軥鈎鉤雊韝鮈鴝鸜鸲"},
